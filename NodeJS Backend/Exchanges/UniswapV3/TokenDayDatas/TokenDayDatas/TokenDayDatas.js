...
exports.getTokenDayData = void 0;
var BlockHelper_1 = require("../../../../GraphQL/Blocks/BlockHelper");
var QueryHelper_1 = require("../../../../GraphQL/QueryHelper");
var TokenDayDatasQueryBuilder_1 = require("./TokenDayDatasQueryBuilder");
function getTokenDayData(first, orderBy, orderDirection) {
    return __awaiter(this, void 0, void 0, function () {
        var promises, blocks, first_count_down, i, adjusted_first, skip_amount, query_str, tokenDayDatas, results, _i, results_1, result;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    while (first_count_down > 0) {
                        ...
                        skip_amount = 1000 * i;
                        query_str = (0, TokenDayDatasQueryBuilder_1.TokenDayDatas)(adjusted_first, skip_amount, orderBy, orderDirection, undefined, blocks[0].number);
...
exports.getTokenDayData = getTokenDayData;
//# sourceMappingURL=TokenDayDatas.js.map