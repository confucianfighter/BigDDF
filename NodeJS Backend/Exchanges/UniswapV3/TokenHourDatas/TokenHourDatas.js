...
exports.getTokenHourData = void 0;
var BlockHelper_1 = require("../../../GraphQL/Blocks/BlockHelper");
var QueryHelper_1 = require("../../../GraphQL/QueryHelper");
var TokenHourDatasQueryBuilder_1 = require("./TokenHourDatasQueryBuilder");
function getTokenHourData(first, orderBy, orderDirection) {
    return __awaiter(this, void 0, void 0, function () {
        var promises, blocks, first_count_down, i, adjusted_first, skip_amount, block, query_str, tokenHourDatas, results, _i, results_1, result;
            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    while (first_count_down > 0) {
                        ...
                        query_str = (0, TokenHourDatasQueryBuilder_1.buildTokenHourDatas)(adjusted_first, skip_amount, orderBy, orderDirection, undefined, block);
...
exports.getTokenHourData = getTokenHourData;
//# sourceMappingURL=TokenHourDatas.js.map